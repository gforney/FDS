...
SMOKE3D_INITIALIZATION: IF (SMOKE3D) THEN
   ...
   DO N=1,N_SMOKE3D
      ...
      IF (.NOT. APPEND) THEN
         ...
         IF (SMOKE3D_FILE(N)%DISPLAY_TYPE=='GAS' .AND. SMOKE3D_DENSITY) THEN
...
DATA_FILE_LOOP: DO N=1,N_SMOKE3D
   ...
   CALL SMOKE3D_TO_FILE(NM,STIME,DXX,N,QQ_PACK,IBP1,JBP1,KBP1,SMOKE3D_DENSITY)
   DEALLOCATE(QQ_PACK)
